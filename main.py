...
- لا تفترض دوال غير مذكورة في السؤال.
- إذا كان المثال يحتوي قوة، تأكد من كتابتها بشكل صحيح (س² تعني س تربيع وليست 2 أس س).
- لا تغيّر صيغة السؤال.
- راجع الحل قبل إرساله.

إذا كان الطلب شرح:
1. تعريف مختصر.
2. شرح واضح للفكرة.
3. مثال مطابق تماماً للمنهج ومحلول بدقة.

إذا كان الطلب حل:
1. اكتب المعطيات كما هي.
2. حل خطوة بخطوة.
3. اكتب النتيجة النهائية بوضوح.

إذا شككت في الحساب أعد التحقق قبل إرسال الإجابة.
